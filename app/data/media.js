const data = [
  {
    title: 'Julio Maldonado: Software engineer, DACA recipient',
    subtitle: '',
  ...
  {
    title: 'Commentary: Inland Border Patrol checkpoints shouldn’t hurt those who live here',
    ...
    + 'Maldonado, a “Dreamer” protected from deportation by the Deferred Action for Childhood Arrivals '
    + 'program, would be the first in the family to graduate from college. Unfortunately, because of their '
    + 'citizenship status, Maldonado’s parents couldn’t be there to cheer him on...',
  },
  {
    title: 'GraphBLAS: Solving Graph Algorithms with Linear Algebra',
    subtitle: '',
    ...
    + 'GraphBLAS also allows linear algebra operations on its graphs, so that users can develop graph algorithms in the language of linear algebra. '
    + 'Concluding that GraphBLAS is a more efficient and concise way of writing graph algorithms is important to academia, '
    + 'as it’d introduce a better approach for researchers and students to learn and write graph algorithms...',
  },
  {
    title: 'Graduation',
    subtitle: '',
    link: 'https://www.facebook.com/photo.php?fbid=2184177261672453&set=a.369577416465789&type=3&theater',
    image: '/images/media/graduation_family_dasilve.jpg',
    type: 'Personal Story',
    alt: 'Graduation photo with Dr. Da Silva',
    date: 'May 12, 2019',
    desc: 'I graduated yesterday from Texas A&M University. My parents couldn’t be there because they couldn’t pass the checkpoint out of the Valley. '
    + 'Today, on Mother’s Day, Dr. Dilma Da Silva, the Department Head of Computer Science and Engineering, flew out to McAllen so that she could have lunch at my favorite restaurant, Taco Palenque, with my family...',
  },
  {
    title: 'Student Senate supports bringing Sul Ross statue stop back to E-Walk',
  ...
  {
    title: '‘Sanctuary’ legislation could affect universities, colleges',
    ...
    + 'amendments to Senate Bill 4, which would outlaw "sanctuary" jurisdictions, Texas A&M '
    + 'University sophomore Julio Maldonado predicted if the bill passed, it would harm colleges and '
